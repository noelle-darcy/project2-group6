        ...
        //**-add function to count how many days dog will be in kennel for */
...
// WHAT SHOULD BE STORED IN DOG APPTS DATABASE
// (you can't store an object but here are the variables :)
var dogAppt = {
    overallSession: 'boarding',                     //will most likely want to store wether it's a daycare/boarding session or not
    dropoffDate: '', 
    pickupDate: '',
...
// Replace these variables from dog database
var dogName = 'Brody';
var dogWeight = 30;

//Replace these variables with user input
var dropoffDate = 'November 20th';
var pickupDate = 'November 30th';
var daysInBoarding = 10;                //FUNCTION TO FIGURE OUT NUMBER OF DAYS IN BOARDING!!
